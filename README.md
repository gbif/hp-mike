...
[![Build Status](https://builds.gbif.org/job/hp-mike/badge/icon)](https://builds.gbif.org/job/hp-mike/lastBuild/console)
...
# GBIF Hosted Portal: mike (updated 2)

This Jekyll website, **[mike (Staging)](https://mike.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
